...
# ⚠️ Ningún mensaje empieza con «[»: Codex lee como JSON una salida que arranca así, y si no lo es,
# marca el hook como fallido.
...
# Skills: Codex las lee de .agents/skills y Claude Code de .claude/skills. Se copian las que falten.
[ -x Tools/sincronizar-skills.sh ] && bash Tools/sincronizar-skills.sh --silencioso
